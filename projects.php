...
<section class="project">
	...
	<article>
		...
		<p>
			Until december 2012, <a href="http://thomaskeunebroek.fr">Thomas Keunebroek</a> and I were just admins of the website, but we then decided to rebuild it from scratch. We'll like the new UVweb to be smartest, easier to use and to have a responsive design. And of course, as Android lovers, we couldn't help but develop an Android app for phones and tablets with it.
		</p>
		<p>
...
<section class="project">
	<aside>
		<p class="projecticon"><img src="./img/ri02-icon.jpg" alt="ri02 icon"/></p>
		<ul>
	...
	<article>
		<h1>Decision Helping Expert System for Erasmus students</h1>
		<p>
