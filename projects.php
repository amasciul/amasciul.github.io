...
<section class="project">
	...
	<article>
		...
		<p>
			Until december 2012, <a href="http://thomaskeunebroek.fr">Thomas Keunebroek</a> and I were just admins of the website, but we then decided to rebuild it from scratch. We'll like the new UVweb to be smartest, easier to use and to have a responsive design. And of course, as Android lovers, we couldn't help but develop an Android app with it.
		</p>
		<p>
